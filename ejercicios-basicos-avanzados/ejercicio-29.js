...
console.log("Diccionario de Star Wars por décadas:");
console.log(moviesByDecade);

//el object.groupby aqui es god y el floor para el return
//const moviesByDecade = Object.groupBy(starWarsMovies, (movie) => {
